...
public class CompetitionController {
    ...
    private CompetetionListener competitionClickListner;


    private Listener editReloadListner;

    @FXML
    void addNewCompetetion(ActionEvent event) {
        //  display create new competition screen
        try {
            Misc.loadAddCompetetion(childPane,organizer);
        } catch (IOException e) {
    ...
    private void updateCompetitionList(){
        ...
        try {
            for (Competition competition : competitions) {
                AnchorPane content = Misc.getCompetetionCard(competition,competitionClickListner);
    ...
    public void initialize(Organizer o) {
        this.organizer=o;
        this.competitions= CompetetionDBHandler.getCompetitions(organizer);

        competitionClickListner=new CompetetionListener() {
            @Override
        ...
        editReloadListner=new Listener() {
            ...
            public void click(String playerName) throws IOException {
                competitions=CompetetionDBHandler.getCompetitions(organizer);
